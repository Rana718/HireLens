...
import { Feature, Pricing } from "@/constant";
...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-[#111111] text-[#E0E0E0] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden">
            ...
            >
                AI Interview
                <span className="absolute -top-2 -right-10 text-[#00FF85] text-xl">
                    Beta
                </span>
            </motion.h1>
            ...
            >
                ...
                <span className="text-[#00FF85]">AI-powered</span> mock
                interviews
            </motion.p>
            ...
            >
                {Pricing.map((plan, index) => (
                    ...
                    >
                        <h3 className="text-2xl font-bold text-[#0077FF] mb-4">
                            {plan.title}
                        </h3>
                        <div className="text-4xl font-bold mb-6 text-[#00FF85]">
                            {plan.price}
                        </div>
                        <ul className="text-left space-y-4">
                            {plan.features.map((feature, i) => (
                                <li key={i} className="flex items-center">
                                    <span className="text-[#00FF85] mr-2">
                                        ✓
                                    </span>{" "}
                                    {feature}
                                </li>
