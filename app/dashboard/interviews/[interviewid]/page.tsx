    ...
    <div className="my-10 mx-5 md:mx-10 lg:mx-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        <div className="flex flex-col gap-6 p-6 bg-white rounded-lg shadow-lg border border-gray-300">
          <div className="mb-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-700"><strong>Job Role/Job Position:</strong> {interviewData.jobPosition}</h2>
          </div>
          <div className="mb-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-700"><strong>Job Description/Tech Stack:</strong> {interviewData.jobDesc}</h2>
          </div>
          <div className="mb-4">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-700"><strong>Years of Experience:</strong> {interviewData.jobExperience}</h2>
          </div>
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg shadow-md border border-gray-200">
          {webcamEnabled ? (
            ...
            <div className="flex flex-col items-center">
              ...
              <Button onClick={() => setWebcamEnabled(true)} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md shadow-sm transition duration-300">
                Enable Webcam
              </Button>
            </div>
          )}
      ...
      <div className="flex justify-center mt-8">
        <Link href={`/dashboard/interviews/${params.interviewid}/start`}>
          <Button className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md shadow-md transition duration-300">Start Interview</Button>
        </Link>
      </div>
    </div>
  );
